      ...
      <div id="examples">
        <div className="projects">
          <div className="project">
            ...
            <div><img src="./img/mto-web-desktop.png" alt="" className="proj-example"/></div>
          ...
          <div className="project">
            ...
            <img src="./img/mto-par-mob.png" alt="" className="proj-example"/>
          ...
          <div className="project">
            ...
            <img src="./img/mto-stu-mob.png" alt="" className="proj-example"/>
            <div className="stores">
              <i className="fa fa-android"></i>
              <i className="fa fa-apple"></i>
            </div>
          ...
          <div className="project">
            ...
            <img src="./img/xdk-ad.png" alt="" className="proj-example"/>
